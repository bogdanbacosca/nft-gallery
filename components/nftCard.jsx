export const NFTCard = ({ nft }) => {
    ...
    return (
    <div className="w-[10rem] h-[17rem] p-2 flex flex-col bg-slate-100 rounded-md shadow-m mt-4 hover:bg-blue-200 hover:shadow-2xl">
            <div className="flex justify-center">
            <img className="h-[9rem] w-[9rem] rounded" src={nft.media[0].gateway} ></img>
            </div>
