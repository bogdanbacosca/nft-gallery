...
export default function Home() {
    ...
    return (
      ...
      <div className='flex flex-wrap flex-col w-full justify-center items-center m-0 p-0 text-gray-900'>
        ...
        <img src='/images/find.png' width={24} height={24} /><input className='ml-1' onChange={(e)=>{setWalletAddress(e.target.value)}} value={wallet} type={"text"} placeholder="Add your wallet address"></input></div>


         <div className='flex items-center'>
          <img src='/images/findcollection.png' width={24} height={24} />
         <input className='my-2 ml-1' onChange={(e)=>{setCollectionAddress(e.target.value)}} value={collection} type={"text"} placeholder="Add the collection address"></input></div>
         ...
         <button className={"disabled:bg-slate-500 text-white bg-blue-500 px-4 py-2 mt-3 rounded-sm w-25 hover:bg-slate-700 flex"} onClick={
          ...
          <div className='flex flex-wrap gap-y-4 my-4 mx-0 w-full gap-x-4 justify-center items-top p-0'>
          {
          NFTs.map(nft => {
            return (
